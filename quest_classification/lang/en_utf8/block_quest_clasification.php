...
$string['clasificationquest'] = 'Clasification QUEST';
$string['error_emptyquestid'] = 'A QUEST instance is needed to view its clasification';
...
$string['config_select_quest'] = 'What QUEST instance this block should show the clasification from?';
...
$string['config_use_teams'] = 'Show Teams instead of Individuals? (only if the QUEST instance allows Teams)';
$string['config_show_best'] = 'How many Individuals or Teams will be shown? (0 to disable)';
$string['error_emptyquestrecord'] = 'There is an error in this block: the selected QUEST instance seems to not be on data base.';
$string['team'] = 'Team';
$string['calification'] = 'Score';
$string['user'] = 'User';
$string['namequest'] = 'QUEST $a->name';
$string['config_no_quests_in_course'] = 'This course has no QUESTs. Some QUEST must be added to the course in order to use this block.';
